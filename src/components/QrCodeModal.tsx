  ...
  return (
    <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 backdrop-blur-sm" onClick={onClose}>
      ...
      >
        ...
        <h2 className="text-2xl font-bold mb-4 text-center font-heading">Unirse a la Mesa {tableNumber}</h2>
        <p className="text-center text-slate-400 mb-6">Escanea este código QR para añadir tus pedidos a la cuenta de esta mesa.</p>
        <div className="bg-white p-4 rounded-lg">
          <QRCode value={joinUrl} size={256} style={{ height: "auto", maxWidth: "100%", width: "100%" }} viewBox={`0 0 256 256`} />
        </div>
        <input
          type="text"
          readOnly
