...
const musicTracks = [
  ...
  {
    name: 'Ambiente Inspirador',
    url: 'https://cdn.pixabay.com/audio/2022/08/04/audio_29b28b9728.mp3',
  },
  {
    name: 'Electrónica Animada',
    url: 'https://cdn.pixabay.com/audio/2022/11/17/audio_8746f3488f.mp3',
  },
  {
    name: 'Motivación Acústica',
    url: 'https://cdn.pixabay.com/audio/2022/11/11/audio_a270776f8e.mp3',
  },
];
      ...
      return (
        <div className="text-center">
          ...
          <p className="text-slate-400 mb-6">
            Para usar la generación de vídeo con Veo, necesitas seleccionar una clave API. Esto
            puede incurrir en costes.
          </p>
      ...
      return (
        <div className="space-y-4">
          ...
          <button
            ...
            className="w-full bg-slate-600 hover:bg-slate-500 text-white font-bold py-2 px-4 rounded-lg"
          >
            Generar otro vídeo
          </button>
        </div>
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <textarea
            ...
            rows={3}
            placeholder="Ej: Un dron vuela lentamente alrededor de este plato."
            className="w-full p-2 bg-slate-700 border border-slate-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500"
          ></textarea>
        </div>
        ...
        <button
          ...
          className="w-full bg-indigo-800 text-white py-3 rounded-lg font-bold hover:bg-indigo-700 transition-colors flex items-center justify-center gap-2"
        >
